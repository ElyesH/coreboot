...
const verify_item_t bootblock_verify_list[] = {
	...
	{ VERIFY_FILE, ROMSTAGE, { { nullptr, CBFS_TYPE_STAGE } },
		HASH_IDX_ROM_STAGE, MBOOT_PCR_INDEX_0 },
#endif
	{ VERIFY_FILE, BOOTBLOCK, { { nullptr, CBFS_TYPE_BOOTBLOCK } },
		HASH_IDX_BOOTBLOCK, MBOOT_PCR_INDEX_0 },
	{ VERIFY_FILE, FSP, { { nullptr, CBFS_TYPE_FSP } }, HASH_IDX_FSP,
		MBOOT_PCR_INDEX_1 },
	{ VERIFY_FILE, "spd.bin", { { nullptr, CBFS_TYPE_SPD } },
	...
	{ VERIFY_BLOCK, "PublicKey",
		...
		MBOOT_PCR_INDEX_0 },
#endif
	{ VERIFY_TERMINATOR, nullptr, { { nullptr, 0 } }, 0, 0 }
};
...
const verify_item_t romstage_verify_list[] = {
	{ VERIFY_FILE, ROMSTAGE, { { nullptr, CBFS_TYPE_STAGE } },
		HASH_IDX_ROM_STAGE, MBOOT_PCR_INDEX_0 },
	{ VERIFY_FILE, MICROCODE, { { nullptr, CBFS_TYPE_MICROCODE } },
...
const verify_item_t postcar_verify_list[] = {
	{ VERIFY_FILE, POSTCAR, { { nullptr, CBFS_TYPE_STAGE } },
...
static const verify_item_t ram_stage_additional_list[] = {
	...
	{ VERIFY_FILE, "config", { { nullptr, CBFS_TYPE_RAW } },
		HASH_IDX_CONFIG, MBOOT_PCR_INDEX_0 },
#endif
	{ VERIFY_FILE, OP_ROM_VBT, { { nullptr, CBFS_TYPE_RAW } },
		HASH_IDX_OPROM, MBOOT_PCR_INDEX_2 },
#if CONFIG(BMP_LOGO)
	{ VERIFY_FILE, "logo.bmp", { { nullptr, CBFS_TYPE_RAW } },
		HASH_IDX_LOGO, MBOOT_PCR_INDEX_2 },
#endif
	{ VERIFY_FILE, "fallback/dsdt.aml", { { nullptr, CBFS_TYPE_RAW } },
...
const verify_item_t payload_verify_list[] = {
	{ VERIFY_FILE, PAYLOAD, { { nullptr, CBFS_TYPE_SELF |
